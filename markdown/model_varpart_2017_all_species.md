...
```
    ...
    ## 1            pc3_soil     3 0.07271581 0.07271581 0.04893929 3.058304 0.0018
    ## 2 orientation_numeric     5 0.05047211 0.12318792 0.07703991 2.187402 0.0131
    ## 3  exposition_numeric     4 0.04639787 0.16958578 0.10225490 2.067307 0.0198
...
```
    ...
    ## Testing variable 1
    ## Testing variable 2
    ## Procedure stopped (alpha criteria): pvalue for variable 2 is 0.175700 (> 0.050000)
...
```
    ...
    ## Testing variable 1
    ## Testing variable 2
    ## Procedure stopped (alpha criteria): pvalue for variable 2 is 0.052200 (> 0.050000)
...
```
    ...
    ##               variables order         R2      R2Cum   AdjR2Cum        F pvalue
    ## 1 pc1_construction_year     2 0.05751076 0.05751076 0.03334437 2.379783 0.0107
    ##    p_adj
    ## 1 0.0321
...
```
    ...
    ## 
    ## Model: dbrda(formula = beta_subsets ~ pc1_soil + pc2_soil + pc3_soil + exposition + orientation + location_abb + river_km + river_distance + plot_age + pc1_construction_year + pc2_construction_year + pc3_construction_year, data = sites)
    ##          Df SumOfSqs      F Pr(>F)
    ## Model    18 0.027557 0.1466  0.982
    ## Residual 22 0.229719
