...
m1_substitution_varpart <- varpart(beta_substitution, sites_soil_selected,
                                   sites_space_selected, sites_history_selected)
tiff(here("outputs/figures/figure_4a_2017_(800dpi_12x12cm).tiff"),
...
### Soil ###
m1_substitution <- dbrda(beta_substitution ~ PC3soil + side + exposition + PC1soil +
