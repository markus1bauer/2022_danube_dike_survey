...
data_model <- ggeffect(m8, type = "emm", c("comparison", "exposition"), back.transform = T) %>%
...
### Save ###
ggsave(here("outputs/figures/figure_tbi_bc_presence_comparison_exposition_(800dpi_8x8cm).tiff"),
