...
st_write(germany, layer = "germany_epsg4326.shp", driver = "ESRI Shapefile", delete_layer = TRUE,
         dsn = here("data", "processed", "spatial"))
st_write(rivers, layer = "rivers_epsg4326.shp", driver = "ESRI Shapefile", delete_layer = TRUE,
         dsn = here("data", "processed", "spatial"))
...
#st_write(danube_isar, layer = "danube_isar_digitized_epsg4326.shp", driver = "ESRI Shapefile", delete_layer = T,
         #dsn = here("data", "processed", "spatial"))
st_write(grazing, layer = "grazing_epsg4326.shp", driver = "ESRI Shapefile", delete_layer = TRUE,
         dsn = here("data", "processed", "spatial"))
st_write(dikes, layer = "dikes_epsg4326.shp", driver = "ESRI Shapefile", delete_layer = TRUE,
         dsn = here("data", "processed", "spatial"))
st_write(conservation_area, layer = "conservation_area_epsg4326.shp", driver = "ESRI Shapefile", delete_layer = T,
         dsn = here("data", "processed", "spatial"))
st_write(ffh_area, layer = "ffh_area_epsg4326.shp", driver = "ESRI Shapefile", delete_layer = TRUE,
         dsn = here("data", "processed", "spatial"))
st_write(sites, layer = "sites_epsg4326.shp", driver = "ESRI Shapefile", delete_layer = TRUE,
         dsn = here("data", "processed", "spatial"))
...
sites_basic %>%
  ...
  as.data.frame() %>%
  pgirmess::writeGPX(type = "w", filename = here("data", "processed", "spatial",
