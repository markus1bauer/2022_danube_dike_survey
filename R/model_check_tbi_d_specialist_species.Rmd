---
title: "Analysis of Bauer et al. (unpublished) Beta diversity on dike grasslands: <br> Temporal beta-diversity index (TBI) with specialist species"
...
load(file = here("outputs", "models", "model_tbi_d_all_1.Rdata"))
load(file = here("outputs", "models", "model_tbi_d_all_2.Rdata"))
m_1 <- m1
m_2 <- m2
```
...
```{r dharma_single, collapse = TRUE, fig.height = 3.5}
