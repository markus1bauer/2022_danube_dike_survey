...
#--> riverkm ~ longitude/latitude has r > 0.7 (Dormann et al. 2013 Ecography) --> longitude and latitude have to be excluded
...
car::vif(m8) # all < 3 (Zuur et al. 2010 Methods Ecol Evol) --> remove riverkm
