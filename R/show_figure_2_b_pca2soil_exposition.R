...
(graph_b <- ggplot() +
    ...
    geom_point(data = data,
               ...
               size = 1, color = "grey75", fill = "grey75") +
    ...
    annotate("text",
             ...
             y = c(0, 0),
             size = 2.5) +
    labs(x = "PC2", y = expression(Dissimilarity~"["*TBI[sor]*"]"), color = "Exposition", fill = "Exposition", shape = "Exposition") +
    themeMB())

### Save ###
ggsave(here("outputs/figures/figure_2_b_(800dpi_8x8cm).tiff"),
